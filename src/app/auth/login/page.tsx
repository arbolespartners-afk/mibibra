      ...
      <div className="w-full max-w-sm flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-[#ff2d55] hover:bg-[#e0002d] disabled:opacity-50 disabled:cursor-not-allowed rounded-full font-semibold text-sm text-white transition-colors"
          >
        ...
        <p className="text-center text-sm text-[#003049]/50">
          ¿No tienes cuenta?{" "}
          <Link href="/auth/register" className="text-[#ff2d55] hover:text-[#e0002d] font-medium transition-colors">
            Regístrate gratis
          </Link>
        </p>
      </div>
